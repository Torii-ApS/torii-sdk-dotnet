...
namespace Torii.Backend.Generated.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CursorPageResponseServerOrganizationResponse")]
    public partial class CursorPageResponseServerOrganizationResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CursorPageResponseServerOrganizationResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CursorPageResponseServerOrganizationResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CursorPageResponseServerOrganizationResponse" /> class.
        /// </summary>
        ...
        public CursorPageResponseServerOrganizationResponse(List<ServerOrganizationResponse> items = default, Guid? nextCursor = default, bool hasMore = default)
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new ArgumentNullException("items is a required property for CursorPageResponseServerOrganizationResponse and cannot be null");
            }
            this.Items = items;
        ...
        public List<ServerOrganizationResponse> Items { get; set; }
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CursorPageResponseServerOrganizationResponse {\n");
