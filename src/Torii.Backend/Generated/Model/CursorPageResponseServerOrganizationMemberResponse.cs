...
namespace Torii.Backend.Generated.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CursorPageResponseServerOrganizationMemberResponse")]
    public partial class CursorPageResponseServerOrganizationMemberResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CursorPageResponseServerOrganizationMemberResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CursorPageResponseServerOrganizationMemberResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CursorPageResponseServerOrganizationMemberResponse" /> class.
        /// </summary>
        ...
        public CursorPageResponseServerOrganizationMemberResponse(List<ServerOrganizationMemberResponse> items = default, Guid? nextCursor = default, bool hasMore = default)
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new ArgumentNullException("items is a required property for CursorPageResponseServerOrganizationMemberResponse and cannot be null");
            }
            this.Items = items;
        ...
        public List<ServerOrganizationMemberResponse> Items { get; set; }
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CursorPageResponseServerOrganizationMemberResponse {\n");
