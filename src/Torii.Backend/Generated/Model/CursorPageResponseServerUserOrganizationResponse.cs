...
namespace Torii.Backend.Generated.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CursorPageResponseServerUserOrganizationResponse")]
    public partial class CursorPageResponseServerUserOrganizationResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CursorPageResponseServerUserOrganizationResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CursorPageResponseServerUserOrganizationResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CursorPageResponseServerUserOrganizationResponse" /> class.
        /// </summary>
        ...
        public CursorPageResponseServerUserOrganizationResponse(List<ServerUserOrganizationResponse> items = default, Guid? nextCursor = default, bool hasMore = default)
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new ArgumentNullException("items is a required property for CursorPageResponseServerUserOrganizationResponse and cannot be null");
            }
            this.Items = items;
        ...
        public List<ServerUserOrganizationResponse> Items { get; set; }
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CursorPageResponseServerUserOrganizationResponse {\n");
