...
namespace Torii.Backend.Generated.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CursorPageResponseServerUserResponse")]
    public partial class CursorPageResponseServerUserResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CursorPageResponseServerUserResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CursorPageResponseServerUserResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CursorPageResponseServerUserResponse" /> class.
        /// </summary>
        ...
        public CursorPageResponseServerUserResponse(List<ServerUserResponse> items = default, Guid? nextCursor = default, bool hasMore = default)
        {
            // to ensure "items" is required (not null)
            if (items == null)
            {
                throw new ArgumentNullException("items is a required property for CursorPageResponseServerUserResponse and cannot be null");
            }
            this.Items = items;
        ...
        public List<ServerUserResponse> Items { get; set; }
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CursorPageResponseServerUserResponse {\n");
