...
namespace Torii.Backend.Generated.Model
{
    ...
    public partial class AllowedOriginsResponse : IValidatableObject
    {
        ...
        protected AllowedOriginsResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AllowedOriginsResponse" /> class.
        /// </summary>
        /// <param name="origins">origins (required).</param>
        public AllowedOriginsResponse(List<string> origins = default)
        {
            // to ensure "origins" is required (not null)
            if (origins == null)
            {
                throw new ArgumentNullException("origins is a required property for AllowedOriginsResponse and cannot be null");
            }
