...
namespace Torii.Backend.Generated.Model
{
    ...
    public partial class UserSessionResponse : IValidatableObject
    {
        ...
        */
        ...
        /// </summary>
        /// <value>Platform user behind this session when it was established via impersonation; null for normal sign-ins.</value>
        [DataMember(Name = "impersonatedBy", EmitDefaultValue = true)]
